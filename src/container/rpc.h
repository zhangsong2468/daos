...
#define DAOS_CO_QUERY_PROP_SCRUB_DIS		(1ULL << 6)
#define DAOS_CO_QUERY_PROP_REDUN_FAC		(1ULL << 7)
#define DAOS_CO_QUERY_PROP_REDUN_LVL		(1ULL << 8)
#define DAOS_CO_QUERY_PROP_SNAPSHOT_MAX		(1ULL << 9)
#define DAOS_CO_QUERY_PROP_COMPRESS		(1ULL << 10)
#define DAOS_CO_QUERY_PROP_ENCRYPT		(1ULL << 11)
#define DAOS_CO_QUERY_PROP_ACL			(1ULL << 12)
#define DAOS_CO_QUERY_PROP_OWNER		(1ULL << 13)
#define DAOS_CO_QUERY_PROP_OWNER_GROUP		(1ULL << 14)
#define DAOS_CO_QUERY_PROP_DEDUP		(1ULL << 15)
#define DAOS_CO_QUERY_PROP_DEDUP_THRESHOLD	(1ULL << 16)
#define DAOS_CO_QUERY_PROP_ROOTS		(1ULL << 17)
#define DAOS_CO_QUERY_PROP_CO_STATUS		(1ULL << 18)
#define DAOS_CO_QUERY_PROP_ALLOCED_OID		(1ULL << 19)
#define DAOS_CO_QUERY_PROP_EC_CELL_SZ		(1ULL << 20)

#define DAOS_CO_QUERY_PROP_BITS_NR		(21)
