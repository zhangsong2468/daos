...
static const struct CMUnitTest cm_tests[] = {
	{ "M_POOL1: connect/disconnect to pool (async)", //POOL3
	  pool_connect, async_enable, test_case_teardown},
	{ "M_POOL2: exclusive connection", //POOL5
	  pool_connect_exclusively, NULL, test_case_teardown},
	{ "M_POOL3: set/get/list user-defined pool attributes (sync)", //POOL6
	  pool_attribute, NULL, test_case_teardown},
	{ "M_POOL4: pool query/list containers", //POOL12
	  pool_query_list, NULL, test_case_teardown},
	{ "M_POOL5: pool connect access based on ACL", //POOL14
	  pool_connect_access, NULL, test_case_teardown},
	{ "M_CONT1: create/open/close/destroy container (async)", // CONT2
	  co_create, async_enable, test_case_teardown},
	{ "M_CONT2: set/get/list user-defined container attributes (sync)", // CONT4 modified
	  co_attribute, async_disable, test_case_teardown},
	{ "M_CONT3: create container with properties and query", //CONT6
	  co_properties, NULL, test_case_teardown},
	{ "M_CONT4: container destroy access denied", //CONT11
	  co_destroy_access_denied, NULL, test_case_teardown},
	{ "M_CONT5: container open access by ACL", //CONT13
	  co_open_access, NULL, test_case_teardown},
	{ "M_CONT6: container query access by ACL", //CONT14
	  co_query_access, NULL, test_case_teardown},
	{ "M_CONT7: container get-acl access by ACL", //CONT15
	  co_get_acl_access, NULL, test_case_teardown},
	{ "M_CONT8: container overwrite/update/delete ACL access by ACL", //CONT17
